...
const Filter = (props) => {
  ...
  const handleFuelType = (event) => {
    ...
    if (event.target.checked) fuelType[event.target.value] = event.target.value;
    else delete fuelType[event.target.value];
    ...
    <>
      <div className={classes.mainContainer}>
        ...
        <div className={classes.box}>
          <div>
            <div className={classes.filterOptionHeader}>Segment</div>
            {displaySegments()}
          </div>
          <div>
            <div className={classes.filterOptionHeader}>Fuel Type</div>
            {displayFuelType()}
          </div>
          <div>
            <div className={classes.filterOptionHeader}>Transmission Type</div>
            {displayTransmission()}
          </div>
          <div>
            <div className={classes.filterOptionHeader}>Seating Capacity</div>
