        ...
        <div className={classes.container}>
          <div className={classes.subContainerFirst}>
                ...
                <div className={classes.cardBody}>
                  <div className={classes.cardFirst}>
                    <div className={classes.cardFirstHeading}>
                      <b style={{ fontSize: 18 }}>
                        {vehicleDetails.modelname} {vehicleDetails.companyname}
                      </b>
                    </div>
                    <br />
                    <img
                      className={classes.cardFirstImage}
                      src={`${ServerURL}/images/${vehicleDetails.icon}`}
                      alt="Creta"
                    />
                    <br />
                    <div className={classes.carDetails}>
                      <div className={classes.subCarDetails}>
                        <img
                          src="/assets/icontransmission.svg"
                          alt="Automatic"
                          style={{
                            marginRight: 6,
                        ...
                        />
                        <br />
                        <span className={classes.carDetailsText}>Manual</span>
                      </div>
                      <div className={classes.subCarDetails}>
                        <img
                          src="/assets/icondiesel.svg"
                          alt="Automatic"
                          style={{
                            marginRight: 6,
                            verticalAlign: "middle",
                    ...
                    <span style={{ fontSize: 18 }}>
                      ...
                      <div style={{ display: "inline-flex" }}>
                        <span style={{ marginRight: 20 }}>
                          <b>City :{bookingDetails.city}</b>
                        </span>
                      </div>
                      <br />
                      <div style={{ display: "inline-flex", paddingTop: 10 }}>
                        <span style={{ marginRight: 20 }}>
                          <b>Pricing Plan: Includes 870 kms, Includes fuel</b>
                        </span>
                      </div>
                    </span>
                  </div>
            ...
            <Paper
              square={true}
              elevation={8}
              style={{ marginTop: 8, marginBottom:'30vh' }}
            >
              <div className={classes.card}>
                ...
                >
                  ...
                  >
                    ...
                    <tr>
                      ...
                      <td style={{ paddingBottom: 12 }}>To be paid by you.</td>
                    </tr>
                    <tr>
                      <td style={{ paddingBottom: 12 }}>ID VERIFICATION:</td>
                      <td style={{ paddingBottom: 12 }}>
              ...
              <div style={{ background: "#f1f1f1" }}>
                <div style={{ padding: "1rem" }}>
                  ...
                  >
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style={{ paddingBottom: 6 }}>&#x20B9; {pickup}</td>
                      </tr>
                      <tr>
                        <td style={{ paddingBottom: 6 }}>Insurance</td>
                        <td style={{ paddingBottom: 6 }}>Included</td>
                      </tr>
                      <tr>
                        <td style={{ paddingBottom: 6 }}>
                  ...
                  >
                    <tbody>
                      <tr>
                        <td style={{ paddingBottom: 6 }}>Kms Limit</td>
                        <td style={{ paddingBottom: 6 }}>870 Kms</td>
                      </tr>
                      <tr>
                        <td style={{ paddingBottom: 6 }}>Fuel</td>
                        <td style={{ paddingBottom: 6 }}>Included</td>
                      </tr>
                      <tr>
                        <td style={{ paddingBottom: 6 }}>Extra kms charge</td>
                        <td style={{ paddingBottom: 6 }}>&#x20B9; 11/Km</td>
                      </tr>
                      <tr>
                        <td style={{ paddingBottom: 6 }}>
                          Tolls, Parking & Inter-state taxes
