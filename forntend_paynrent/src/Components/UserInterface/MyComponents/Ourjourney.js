          ...
          >
            ...
            >
              <Box sx={{ padding: "10px 0px", textAlign: "left" }}>
                <div>
                  <img src="assets/OJ_icon1.png" width="70px" />
                </div>
            ...
            >
              <Box sx={{ padding: "10px 0px", textAlign: "left" }}>
                <div>
                  <img src="assets/OJ_icon2.png" width="70px" />
                </div>
            ...
            >
              <Box sx={{ padding: "10px 0px", textAlign: "left" }}>
                <div>
                  <img src="assets/OJ_icon3.png" width="70px" />
                </div>
            ...
            >
              <Box sx={{ padding: "10px 0px", textAlign: "left" }}>
                <div>
                  <img src="assets/OJ_icon4.png" width="70px" />
                </div>
